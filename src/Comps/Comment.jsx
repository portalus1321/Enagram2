              ...
              <Tab.Panel className="-m-0.5 rounded-lg p-0.5">
                ...
                <div>
                  <textarea
                    ...
                    name="comment"
                    id="comment"
                    className="block w-full bg-gray-400 rounded-md border-0 py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-700 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
